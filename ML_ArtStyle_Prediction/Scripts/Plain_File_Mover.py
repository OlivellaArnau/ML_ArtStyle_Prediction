...
# Uso
carpeta_origen = "ruta/a/tu/carpeta/origen"  # Reemplaza con la ruta de tu carpeta de origen
carpeta_destino = "ruta/a/tu/carpeta/destino"  # Reemplaza con la ruta de tu carpeta de destino
